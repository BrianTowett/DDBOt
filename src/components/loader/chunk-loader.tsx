...
export default function ChunkLoader({ message }: { message: string }) {
    ...
    // a `.app-root` flex container that fills its parent — letting the
    // Loader add its own fullscreen overlay on top stacks two fullscreen
    // overlays and hides any sibling content (e.g. the dashboard once a
    // hard-deadline forces it to render).
    return (
