        ...
        <div className='free-bots'>
            ...
            <div className='free-bots__grid'>
                {filteredBots.map(bot => (
                    <div key={bot.id} className={`free-bots__card ${bot.isPremium ? 'free-bots__card--premium' : ''}`}>
                        {bot.isPremium && <div className='free-bots__premium-badge'>PREMIUM</div>}
                        ...
                        {bot.isPremium && <div className='free-bots__stars'>⭐⭐⭐⭐⭐</div>}
                        <p className='free-bots__card-description'>{bot.description}</p>
                        <button
                            className={`free-bots__card-btn ${bot.isPremium ? 'free-bots__card-btn--premium' : ''}`}
                            onClick={() => loadBot(bot)}
                        ...
                        >
                            {loadingBotId === bot.id ? (
                                ...
                                <>
                                    <span>{bot.isPremium ? 'LOAD PREMIUM BOT' : 'Load Bot'}</span>
                                </>
                            )}
                        </button>
                    </div>
